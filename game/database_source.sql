...
INSERT INTO "dialogue" VALUES('/world_1/intro','monty_coming_now','Aaah, I''m coming now! I''ll just be a second. Oh, you can press ''Enter'' or click on the arrow to continue.','Untranslated to French.','Untranslated to Dutch.','Untranslated to Hindi.','Yeaarrr, I''m comin'' now! I''ll just be a second! Ye can press ''Enter'' or click on t'' arrow to continue.');
...
INSERT INTO "dialogue" VALUES('/world_1/intro','monty_doesnt_know_name','Oh, how rude of me, I don''t even know your name!','Untranslated','Untranslated','Untranslated','Oh, how rude o'' me, I almost forgot I don''t even know yer name!');
INSERT INTO "dialogue" VALUES('/world_1/intro','big_white_box','You see the big grey box below me? That is where you''ll write your code.  It''s called the PyScripter.','Untranslated','Untranslated','Untranslated','Ye spy wit'' ye eye th'' big white box below me? That be just where ye''ll write code.');
INSERT INTO "dialogue" VALUES('/world_1/intro','print_name_string','YourName','Untranslated','Untranslated','Untranslated','YerName');
...
INSERT INTO "dialogue" VALUES('/world_1/intro','confirm_player_name','Well hello %player_name%, you are called %player_name% right? Just so you know, you can click on an option to select it or use the arrow keys and hit ''Enter'' on the selected one.','Untranslated','Untranslated','Untranslated','Ahoy %player_name%! Ye be called %player_name% right? Avast, click on an option t'' select it or use t'' arrow keys and hit ''Enter''.');
