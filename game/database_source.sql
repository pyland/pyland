...
INSERT INTO "dialogue" VALUES('/world_1/intro','monty_coming_now','Aaah, I''m coming now! I''ll just be a second. Oh, you can press ''Enter'' or click on the arrow to continue.','Untranslated to French.','Untranslated to Dutch.','Untranslated to Hindi.','Yeaarrr, I''m comin'' now! I''ll just be a second!');
