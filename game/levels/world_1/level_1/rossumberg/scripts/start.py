...
engine.run_callback_list_sequence(dialogue_sequence, lambda: engine.show_dialogue_with_options("Broo", {"south": lambda : player_one.move_south(), "printj" : lambda : engine.print_terminal("j")}))
"""

engine.show_dialogue_with_options("Broo",{
