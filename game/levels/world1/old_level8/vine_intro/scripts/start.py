#This level should introduce loops
#Myla can give you simple loops to get past poisonous vines
#This level should incorporate the puzzle/NPC/Crododile/Vine mechanics from previous levels
#, except at some point you are taught loops and introduced to the poisonous vines
