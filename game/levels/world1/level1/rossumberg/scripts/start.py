...
if heidi_state == heidi_state_speaking_about_prank:
    ...
    heidi_introduction_sequence = [
        ...
        lambda callback: engine.show_dialogue("Crocodiles are attacking our bridge!", callback = callback),
        lambda callback: engine.show_dialogue("Go north!", callback = callback),
