#Myla will introduce cut first
#Then when you need to know how many cuts are left, she will give you the function to call
#and show you how to print it (you have learnt print from level 5)

#Try and reduce the amount of dialogue
