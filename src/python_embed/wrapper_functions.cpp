...
BOOST_PYTHON_MODULE(wrapper_functions) {
    ...
    py::class_<GameEngine, boost::noncopyable>("GameEngine", py::no_init)
        ...
        .def("get_py_tabs",      &GameEngine::get_py_tabs)
        .def("show_external_script",      &GameEngine::show_external_script)
        .def("update_world_text",      &GameEngine::update_world_text)
        .def("update_level_text",      &GameEngine::update_level_text)
        .def("clear_level_text",      &GameEngine::clear_level_text)
        .def("update_coins_text",      &GameEngine::update_coins_text)
        .def("update_totems_text",     &GameEngine::update_totems_text)
